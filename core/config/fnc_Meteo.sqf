...
//
/*
if(isNil "weatherNextName") then {weatherNext = "TBD within next 20 minutes";} else {weatherNext = weatherNextName;};hint format ["Current Weather - %1\nOvercast: %2\nRain/Snow: %3\nFog :%4\nWind: %5\nUpcoming Weather Forecast:\n %6",weatherCurrentName,overcast,rain,fog,wind,weatherNext];
*/
