/*
	...
	author: corvobrok
    Edit: Oyama for Utopia Survivor
	descripttion: Créer des zombies aléatoires près du joueur (plus de zombies si vous êtes dans une ville)
*/

/* -----------------------------------------------------------------------------------------------------------------------------------------------------------------*/
//Type d'unité voir liste => https://community.bistudio.com/wiki/Arma_3_CfgVehicles_CIV <=
// DOIT ETRE IDENTIQUE A fnc_ZPRoximity.sqf

_units =  ["C_man_polo_1_F_euro"];
